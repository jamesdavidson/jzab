...
keytool -keystore "$OUTDIR/keystore_a.jks" -genkey -alias javazab -keypass $PASS -storepass $PASS -dname "$DNAME" -keyalg RSA
keytool -keystore "$OUTDIR/keystore_b.jks" -genkey -alias javazab -keypass $PASS -storepass $PASS -dname "$DNAME" -keyalg RSA
keytool -keystore "$OUTDIR/keystore_c.jks" -genkey -alias javazab -keypass $PASS -storepass $PASS -dname "$DNAME" -keyalg RSA
